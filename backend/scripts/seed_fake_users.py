...
TIER1_CHARACTERS = [
    ...
    {"username": "elif_yoga", "display_name": "Elif Demir", "personality_type": "supportive", "interests": ["yoga", "wellness", "meditation"], "bio": "Nefes al, akışa bırak 🧘 Mindfulness ve denge."},
    {"username": "can_gezgin", "display_name": "Can Yıldız", "personality_type": "energetic", "interests": ["travel", "photography", "food"], "bio": "Dünyayı gezen Türk 🌍 Her hafta yeni bir şehir."},
    ...
    {"username": "selin_kitap", "display_name": "Selin Aydın", "personality_type": "curious", "interests": ["books", "cinema", "art"], "bio": "Kitap kurdu 📚 Ayda bir kitap, haftada bir film."},
    {"username": "burak_futbol", "display_name": "Burak Doğan", "personality_type": "energetic", "interests": ["football", "sport", "fitness"], "bio": "Maç günü enerjisi ⚽ Tribün ve antrenman notları."},
    ...
    {"username": "oguz_doga", "display_name": "Oğuz Kaya", "personality_type": "supportive", "interests": ["nature", "hiking", "camping"], "bio": "Dağlar benim evim 🏔️ Kamp ve trekking rotaları."},
    {"username": "hande_dans", "display_name": "Hande Yılmaz", "personality_type": "energetic", "interests": ["dance", "music", "fitness"], "bio": "Ritim tutkunu 💃 Dans ve hareket her gün."},
    ...
    {"username": "esra_sanat", "display_name": "Esra Bal", "personality_type": "curious", "interests": ["art", "design", "museums"], "bio": "Sanat her yerde 🎨 Sergi ve illüstrasyon paylaşımları."},
    ...
    {"username": "ahmet_yatirim", "display_name": "Ahmet Yıldız", "personality_type": "curious", "interests": ["finance", "tech", "startups"], "bio": "Finans ve girişimcilik 📈 Basit yatırım notları."},
]
